...
const scrapeLinks = async (
    ...
    if (depth > MAX_DEPTH || totalLinksProcessed >= MAX_TOTAL_LINKS || visited.has(url)) {
        return null;
    }
    ...
    try {
        ...
        const title: string = document.querySelector('title')?.textContent || 'No Title';
 ...
 */
export const buildLinkTree = async (startUrl: string): Promise<LinkNode | null> => {
